(function() {
  ...
  Vehicle.ATTRIBUTES = [
    { width: 30, height: 22, loc: [8, 265, 30, 22, 50, 42] },
    { width: 29, height: 24, loc: [45, 264, 29, 24, 49, 44] },
    { width: 24, height: 26, loc: [81, 263, 24, 26, 44, 46] },
    { width: 24, height: 21, loc: [9, 300, 24, 21, 44, 41] },
    { width: 46, height: 19, loc: [105, 301, 46, 19, 66, 39] }
    // save width and height in loc
  ];
})();
