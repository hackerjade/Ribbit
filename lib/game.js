(function() {
  ...
  Game.prototype.checkFrogStatus = function () {
    ...
    if (this.frogSafe()) { this.updateScore(); }
  };

  Game.prototype.frogSafe = function () {
  ...
  Game.prototype.drawLilies = function (ctx) {
    [80, 325, 570, 815, 1060].forEach(function (x) {
